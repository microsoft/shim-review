...
COPY shim-unsigned-x64-15.4-1.cm1.src.rpm /root/shim-unsigned-x64-15.4-1.cm1.src.rpm
COPY shimx64.efi /
COPY shim-15.4.tar.bz2 /
RUN sha256sum /root/shim-unsigned-x64-15.4-1.cm1.src.rpm
RUN rpm -ihv /root/shim-unsigned-x64-15.4-1.cm1.src.rpm
...
RUN rpm -qlp /usr/src/mariner/RPMS/x86_64/shim-unsigned-x64-15.4-1.cm1.x86_64.rpm
RUN rpm2cpio /usr/src/mariner/RPMS/x86_64/shim-unsigned-x64-15.4-1.cm1.x86_64.rpm | cpio -idmv
